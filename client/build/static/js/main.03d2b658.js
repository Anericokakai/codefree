/*! For license information please see main.03d2b658.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      110: function (e, t, n) {
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      var gv = function (e) {
        ...
        bv = { auth: !1, admin: !1 },
        wv = (0, t.createContext)(bv),
        xv = function (e) {
          var t = e.children;
          return (0, Lu.jsx)(wv.Provider, { value: bv, children: t });
        };
                ...
                (0, Lu.jsxs)("form", {
                  ...
                  onSubmit: function (e) {
                    if ((e.preventDefault(), !r))
                      return Et.error("image required");
                    var t = new FormData(c);
                    t.append("id", s), console.log(E(t));
                    var n = t.get("title"),
                      o = t.get("illustration");
                    if (!n || !o)
                      return Et.error("all fields are required required");
                    Ev(t)
                      .then(function (e) {
                        console.log(e),
                          e.data.status &&
      ...
      var _v = function (e) {
        var n = e.state,
          ...
          l = (u.userName, u.token),
          s = u.refreshToken,
          c = u.admin;
        Sv(l, s, c);
        var f = nl();
        (0, t.useEffect)(function () {
          hv(l).then(function (e) {
            console.log(e),
              "token expired" === e.data.status &&
                vv(s).then(function (e) {
                  f(mc(e.data.refreshedToken));
                });
          });
        }, []);
      ...
      var Nv = function (e) {
        ...
        var m = document.querySelector("form");
        return (0, Lu.jsx)("div", {
          ...
          children: (0, Lu.jsx)("div", {
            ...
            children: (0, Lu.jsxs)("form", {
              ...
              onSubmit: function (e) {
                ...
                var t = new FormData(m);
                if ((t.append("course", r), o)) {
                  if (!s) return Et.error("image required");
                  var a = t.get("topic"),
                    i = t.get("description");
                  if (!a || !i)
                    return Et.error("all fields are required required");
                  ...
                  uv(t)
                    .then(function (e) {
                      console.log(e),
                        u(!1),
                        e.data.success && (Et.success(e.data.success), n(!1)),
                        e.data.error && (Et.error(e.data.error), n(!1), u(!1));
                    })
                    .catch(function (e) {
                  ...
                  if (
                    ...
                    console.log(E(t)),
                    !t.get("topic") || !t.get("author"))
                  )
                    return Et.error("All fields are requird");
                  cv(l)
                    .then(function (e) {
                      u(!1),
                        console.log(e),
      ...
      var Lv = function () {
        ...
        Iv = [
          ...
          { path: "/admin/blog", element: (0, Lu.jsx)(kv, {}) },
          { path: "/admin/blogsform", element: (0, Lu.jsx)(Cv, {}) },
          { path: "/admin/blogsform/topic", element: (0, Lu.jsx)(Nv, {}) },
          { path: "/admin/deleteblog", element: (0, Lu.jsx)(_v, {}) },
...
//# sourceMappingURL=main.03d2b658.js.map
